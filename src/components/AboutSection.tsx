...
const AboutSection = (props: Props) => {
  ...
  return (
    <section id="about" className="py-8 md:py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 lg:gap-16 items-center">
            {/* Text first on mobile */}
            <div className="order-1 lg:order-1 space-y-4 md:space-y-6 lg:pl-0">
              ...
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight">
            ...
            <div className="relative order-2 lg:order-2">
              <div className="absolute top-0 left-6 md:left-12 w-full h-full border-2 md:border-4 border-accent rounded-lg transform translate-x-2 md:translate-x-4 -translate-y-2 md:-translate-y-4 z-0" aria-hidden="true"></div>
              ...
              <div className="absolute top-4 right-0 md:top-8 bg-accent text-accent-foreground px-4 py-2 md:px-6 md:py-4 rounded-lg shadow-lg z-20 transform translate-x-4 md:translate-x-8" aria-label={`${yearsOfExperience} years of experience`}>
                <div className="text-2xl md:text-4xl font-bold text-center" aria-hidden="true">{yearsOfExperience}</div>
                <div className="text-[10px] md:text-xs font-semibold text-center mt-0.5 md:mt-1">Years of Experience</div>
              </div>
